        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-12 xl:px-16 py-8 lg:py-0">
          <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl">
            ...
            <div className="text-center lg:text-left mb-6 lg:mb-8">
              ...
              <p className="text-gray-600 mt-3 text-base lg:text-lg">Create your account and start your learning journey</p>
            </div>
                 ...
                 <div>
                   ...
                   <div className="relative">
                     <input
                       type="text"
                       id="name"
                       className="w-full px-4 py-3 lg:py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-base"
