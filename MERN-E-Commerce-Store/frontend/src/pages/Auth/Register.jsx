        ...
        <div className="flex-1 flex items-center justify-center px-6 sm:px-8 lg:px-16 xl:px-20 py-10 lg:py-0">
          <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl">
            ...
            <div className="text-center lg:text-left mb-8 lg:mb-10">
              ...
              <p className="text-gray-600 mt-4 text-base lg:text-lg">Create your account and start your learning journey</p>
            </div>
                 ...
                 <div>
                   ...
                   <div className="relative">
                     <input
                       type="text"
                       id="name"
                       className="w-full px-5 py-4 lg:py-5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-base"
