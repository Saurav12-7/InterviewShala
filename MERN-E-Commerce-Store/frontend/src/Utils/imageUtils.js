 ...
 * @param {string} imageUrl - The image URL from the database or public folder
...
export const getImageUrl = (imageUrl) => {
  ...
  // If it's a static image from public folder (starts with /images/), return as is
  // These will be served by Vercel from the public folder
